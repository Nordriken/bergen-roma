...
el('f-fjern-bilde').onclick = () => {
  valgtBilde = null;
  el('f-bilde').value = '';
  el('forhandsvis').hidden = true;
};
...
function lukkLysboks(){ el('lysboks').hidden = true; el('lysboks-bilde').removeAttribute('src'); }
el('lysboks-lukk').onclick = lukkLysboks;
el('lysboks').onclick = e => { if (e.target === el('lysboks')) lukkLysboks(); };
